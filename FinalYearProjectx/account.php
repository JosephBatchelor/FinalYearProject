      ...
      if (isset($_SESSION['userId'])) {
        ...
        <div class="action" action="includes/logout.inc.php" method="post">
          <div class="Profile" onclick="menuToggle();">
            <img src="photos/defaultUserphoto.png" alt = "">
          </div>
    ...
    <?php
     ...
     ?>
        ...
        <div class="menu">
          <ul>
            <!--<br><br>-->
           <li> <button class = "SideBut" onclick="ToggleOverview()" id = "Overviewsbutt"><ion-icon class="icon" name="home"></ion-icon> Overview</button> </li>
           <li> <button class = "SideBut"> <ion-icon class="icon" name="share-alt"></ion-icon> Transfer</button> </li>
           <li> <button class = "SideBut" onclick="ToggleServices()" id = "Servicessbutt"><ion-icon class="icon" name="repeat"></ion-icon> Analytics</button> </li>
           <li> <button class = "SideBut" onclick="ToggleProfile()"  id = "Profilebutt"> <ion-icon class="icon" name="reverse-camera"></ion-icon> Profile</button> </li>
      ...
      if ($resultCheck > 0) {
          while ($row = mysqli_fetch_assoc($result)) {
            if (is_null($row['DataToken'])) {
                ...
                echo '
                <div class ="introductioncontianer">
                <div class = "introduction">
                <h1>Connect your banks now </h1>
                <p class ="introductioninfo">Through quick and secure methods you can have access:</p>
                
                <li class ="LIST">Transaction history</li>
                <li class ="LIST">Mutliple Account Balances</li>
                <li class ="LIST">Monthly Expenditures</li>
                <li class ="LIST">Standing orders & Direct Debts</li>
                 <br>
                <a class = "redirect" href="https://jb1828.brighton.domains/FinalYearProject/Signintemp" target="popup" onclick="window.open"https://jb1828.brighton.domains/FinalYearProject/Signintemp','name','width=800,height=1000")">Connect now</a>
                </div>
                                <h1 class= "tessubtitlet">Mutliple banks in one location</h1>
                                <img class = "imagecontainer1" src="photos/dashboardExample.png">
                                <img class = "imagecontainer2" src="photos/istockphoto-1257972122-612x612.jpg">
            ...
            <script>
                    var Overviewsbutt = document.getElementById("Overviewsbutt");
                    var Servicessbutt = document.getElementById("Servicessbutt");
                    var Profilebutt = document.getElementById("Profilebutt");
                    var savingsbutt = document.getElementById("savingsbutt");
                    
                    Overviewsbutt.disabled = true;
                    Servicessbutt.disabled = true;
                    Profilebutt.disabled = true;
                    savingsbutt.disabled = true;
           </script>';
            }else{
                echo'
                <script>
                 Overviewsbutt.disabled = false;
                    Servicessbutt.disabled = false;
                    Profilebutt.disabled = false;
                    savingsbutt.disabled = false;
     ...
     scales: {
              ...
              <div class = "Filtersection">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                            ...
                            console.log("Sucessful ajax post to file :/post.php")
                    }
                    });
                            });
                    });
        ...
        <div class = "Savingswidgets">
                    ...
                    <div id = "innerbanner">
                        ...
                        <div class="form-popup" id="myForm">
                          <div class="form-container">
                            ...
                            console.log("Sucessful ajax post to file :/SavingsCreation.php")
                            }
                            });
                            $("#savingsdisplay").load("SavingsDisplay.php");
                                    });
         ...
         <div class = "widgetinformation">
            ...
            <script>
                            ...
                            console.log("Sucessful ajax post to file :/SavingsTopUpFunction.php")
                            }
                            });
                                    });
                            });
        ...
        <div id="Profile">
          <div class="UserData">
            ...
            <button id = "editbut" onclick="ToggleEdit()">Edit</button>
