...
//Checks if anoy of the fields sent are Empty.
  if (empty($username) || empty($email) ||  empty($password)|| empty($paswordRepeat)|| empty($dateofbirth) || empty($gender) ||  empty($age)|| empty($country) || empty($postcode) || empty($addressline1) ||  empty($addressline2)) {
